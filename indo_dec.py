...
def menu(my_name,my_id,my_birthday):
	...
	print(x+'['+h+'•'+x+'] \033[93mTanggal  Crot     : '+str(birth))
	print(x+'['+h+'•'+x+'] \033[93mIp hp lo          : '+str(sh['origin']))
