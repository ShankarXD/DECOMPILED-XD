...
try:
    rq = requests.get('https://raw.githubusercontent.com/KR1SHNA35/KR1SHNA/main/KR1SHNA.txt').text
...
def banner():
        os.system("clear")
        os.system('echo -e "\n\x1b[1;91m___   _  ______    ___   _______  __   __  __    _  _______  \n\x1b[1;91m|   | | ||    _ |  |   | |       ||  | |  ||  |  | ||   _   | \n\x1b[1;92m|   |_| ||   | ||  |   | |  _____||  |_|  ||   |_| ||  |_|  | \n\x1b[1;92m|      _||   |_||_ |   | | |_____ |       ||       ||       | \n\x1b[1;91m|     |_ |    __  ||   | |_____  ||       ||  _    ||       | \n\x1b[1;93m|    _  ||   |  | ||   |  _____| ||   _   || | |   ||   _   | \n\x1b[1;93m|___| |_||___|  |_||___| |_______||__| |__||_|  |__||__| |__| \n\x1b[1;97m------------------------------------------------\n \n \x1b[1;93m(*)\x1b[1;95m Auther    : Anurag  \n \x1b[1;93m(*)\x1b[1;93m FB        : facebook.com/Anuragaanand.karn.99\n \x1b[1;93m(*)\x1b[1;95m Tool Name : KR1SHNA\n \x1b[1;93m(*)\x1b[1;91m Github    : https://github.com/KR1SHNA35\n\x1b[1;97m------------------------------------------------" | lolcat')
        print("") 
...
def genkey():
	try:
		...
		subprocess.check_output(["am", "start", "https://wa.me/+17372766883"])
		exit()
	except(IOError):
		rb = rx
