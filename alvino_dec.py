...
def banner():
	...
	sol().print(wel2)
	au=' ░▐█▀█▒▐█▀▀▄░░▄█▀▄─░▐█▀█▒▐█▒▐▀  AUTHOR : DANZZ X NANO & NCEK-XD \n ░▐█──▒▐█▒▐█░▐█▄▄▐█░▐█──▒▐██▌░  GITHUB: DANZZ-XD \n ░▐█▄█▒▐█▀▄▄░▐█─░▐█░▐█▄█▒▐█▒▐▄  FB: Danzz Jelek & NCEK'
...
def passwrd():
	ler = '# JANGAN LUPA BERDOA AGAR HASILNYA IJO#'
...
{P}[•]{B}----------------------------------------------------{P}[•]
{B} |
{P}[•] AUTHOR : DANZZ X NANO
{P}[•] WHATSAPP : 081295853971
{B}[•] FACEBOOK : Danzz Gamteng""")
def licensi():#line:42
  try :#line:43
    os .system ('clear')
    kontol()
...
def grup1(urls):
	use = []
	ses = requests.Session()
	print(""+balmond+m+" Jika Stack, Mode Pesawat 5 Detik")
	print(balmond+m+" Sedang Mengumpulkan ID")
	print(balmond+m+" Tekan CTRL + C Untuk Stop")
	while True:
		try:
			ua = 'Mozilla/5.0 (SymbianOS/9.3; Series60/3.2 NokiaE52-1/052.003; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/525 (KHTML, like Gecko) Version/3.0 BrowserNG/7.2.6.2 3gpp-gba'
			miskinlu = {"user-agent": ua}
