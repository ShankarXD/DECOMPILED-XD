...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ MESSENGER🔰🥰https://m.me/Alikhankijan")
	subprocess.check_output(["am", "start", "https://m.me/Alikhankijan"])

def irfan():
	
	
	runtxt("\n\033[0;91m🧞‍This tool is offical for ABEERA")
...
##     ## ########  ######## ######## ##     ## ##     ##                                         
\033[1;90m═══════════════════════════════════════════════════════════
\033[1;94m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : ABEERA.X.X.X  
\033[1;95m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : NAHI RAKHTI
\033[1;93m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : USE NAHI KSRTI🥴
\033[1;97m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : ABEERPASS ABEER ABBERA
\033[1;90m═══════════════════════════════════════════════════════════
    """)
		print("%s [%s•%s] %sTOOL NAME : %sABEERA❌ PROO CLONER❌"%(G,R,G,B,G))
